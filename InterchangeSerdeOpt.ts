...
/**
 * @description Interchange options for serilization
 * @typedef {object} InterchangeSerdeOpt
 ...
 */
export class InterchangeSerdeOpt {
  constructor (options: InterchangeSerdeOpt = {}) {
...
/**
 * @description Set default values for any missing InterchangeSerdeOpt in an options object.
 * @param {InterchangeSerdeOpt} [options] - Options for serializing to and from EDI.
 * @returns {InterchangeSerdeOpt} Serialization options with defaults filled in.
 */
export function defaultSerializationOptions (options?: InterchangeSerdeOpt): InterchangeSerdeOpt {
  return new InterchangeSerdeOpt(options)
}